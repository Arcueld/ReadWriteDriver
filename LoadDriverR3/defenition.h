...
typedef NTSTATUS(NTAPI* pNtConvertBetweenAuxiliaryCounterAndPerformanceCounter)(
    _In_ BOOLEAN ConvertAuxiliaryToPerformanceCounter,
    _In_ PVOID PerformanceOrAuxiliaryCounterValue,
    _Out_ PVOID ConvertedValue,
    _Out_opt_ PVOID ConversionError
    );
